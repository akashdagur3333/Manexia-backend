...
exports.register = async ({ name, email, password,org,role }) => {
...
exports.login = async ({ email, password }) => {
  ...
  const token = jwt.sign(
    { userId: user._id, organization:{ orgId:user.organization._id,name:user.organization.name},name:user.name,email:user.email, roleId: role._id,
    permissions },
